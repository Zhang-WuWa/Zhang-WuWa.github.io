练度流程列表['chun'] = {
    ...
    buff_列表: {
        ...
        "声骸-实战-副词条": { "属性": { "暴击": 40.5, "爆伤": 82.2, "大攻击": 8.6, "小攻击": 40 }, "标签": "实战" },
        "声骸-实战-副词条-共鸣解放": { "属性": { "增伤": 22.9 }, "标签": "共鸣解放,实战" },

        '深塔-30攻': { 属性: { 大攻击: 30 }, 标签: '实战', 描述: '角色受到治疗时，全队攻击提升30%，持续20秒' },
    ...
    流程: function () {
        ...
        this.add_action('红A1 8892', 0.9633, '湮灭', '普攻')
        this.add_action('红A2 ', 0.4563 * 2, '湮灭', '普攻')
        this.add_action('/check 红A2 4212', 0.4563, '湮灭', '普攻')
