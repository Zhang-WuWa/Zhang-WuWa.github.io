练度流程列表['carlotta'] = {
    标题: '珂莱塔25秒136.84w',// 专武提升18%
    // 大号 珂折维 专武 1015783.5 提升20.34%
    // 大号 珂折维 无专 844108.6
    // 大号 珂折守 专武 1122397.8
    // 大号 珂折守 无专 929693.5
    声骸配置: {
    ...
    buff_列表: {
        ...
        // '死与舞': { 属性: { 基础攻击: 587, 暴击: 24.3, 大攻击: 12 } },
        ...
        // "声骸-实战": { "属性": { "暴击": 0, "小攻击": 0, "增伤": 30, "大攻击": 0 }, "标签": "实战" },
        // "声骸-实战-副词条": { "属性": { "暴击": 44.1, "爆伤": 129.8, "大攻击": 0, "小攻击": 1132 }, "标签": "实战" },
        // "声骸-实战-副词条-共鸣技能": { "属性": { "增伤": 22.9 - 12 }, "标签": "共鸣技能,实战" },
    ...
    流程: function () {
        ...
        this.add_buff('揭幕者-倍率提升80%')

        this.add_action('/check 下落1级 5446', .5270, '冷凝', '普攻')
        this.add_action('下落', 1.0478, '冷凝', '普攻')

        this.add_action('/check 回路7级 第1段 9011', 0.5333, '冷凝', '共鸣技能')

        this.add_buff('死与舞-缄默悼词', -1)

        this.add_action('/check 回路7级 第2~4段 不暴击2285 7493', 0.5333, '冷凝', '共鸣技能')
        this.add_action('/check 回路7级 第6段 56189', 3.9992, '冷凝', '共鸣技能')
        this.add_action('回路 6段总计', .6683 * 5 + 5.0121, '冷凝', '共鸣技能')
