练度流程列表['珂莱塔20'] = {
    ...
    buff_列表: {
        ...
        '无归的谬误': { 属性: { 大攻击: 24 }, 描述: '全队角色攻击提升10%，持续20秒。技能冷却：20秒' },
    ...
    流程: function () {
        ...
        this.add_action('test E 2217.4', 2.8822e-4, '冷凝', '共鸣技能')
        this.add_action('test E 2217.4', 2.8822e-4, '冷凝')
        ...
        this.add_action('变奏', 2.98, '冷凝')

        this.add_buff('揭幕者')

        // this.add_action('E', 7.9213, '冷凝', '共鸣技能')
        this.add_action('E', 2.8822, '冷凝', '共鸣技能')
        this.add_action('E', 5.6364, '冷凝', '共鸣技能')

        this.add_buff('死与舞-缄默悼词', -1)
        this.add_action('Z', 8.3536, '冷凝', '共鸣技能')
        ...
        this.add_buff('凌冽决断之心-5-释放共鸣解放')
        this.add_action('test R2', (1.8364 + 0.1450 * 4), '冷凝', '共鸣技能', '揭幕者')
