练度流程列表['忌炎20'] = {
    ...
    buff_列表: {
        ...
        "声骸-检查-副词条": { "属性": { "暴击": 36.9, "爆伤": 75, "小攻击": 30 }, "标签": "检查" },
        "声骸-检查-副词条-重击": { "属性": { "增伤": 18.8 }, "标签": "重击,检查" },
        "声骸-检查-副词条-共鸣技能": { "属性": { "增伤": 10.1 }, "标签": "共鸣技能,检查" },

        '深塔-逆10抗性': { 属性: { 抗性: 10 }, 标签: '检查' },
