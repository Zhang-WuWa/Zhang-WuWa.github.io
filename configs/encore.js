...
练度流程列表['安可'] =
{
    ...
    buff_列表: {
        ...
        // ...声骸属性,
        '声骸-检查': { 属性: { 爆伤: 44, 大攻击: 66, 小攻击: 350, 增伤: 30 }, 标签: '检查' },
        '声骸-检查-副词条': { 属性: { "暴击": 22.5, 爆伤: 78.6, 大攻击: 36.8, 小攻击: 80 }, 标签: '检查' },
        '声骸-检查-副词条-普攻': { 属性: { 增伤: 33.7 }, 标签: '普攻,检查' },
        '声骸-检查-副词条-共鸣技能': { 属性: { 增伤: 8.6 }, 标签: '共鸣技能,检查' },
        '声骸-检查-副词条-共鸣解放': { 属性: { 增伤: 10.1 }, 标签: '共鸣解放,检查' },

        '深塔-10抗': { 属性: { 抗性: -10 } },
        '深塔-6增伤': { 属性: { 增伤: 6 }, 标签: '检查', 描述: '角色释放声骸技能时，全队全属性伤害提升6%，最多叠加4层，同角色的同名声骸技能无法重复触发该效果。叠加至4层时，全队暴击伤害提升36%。' },
