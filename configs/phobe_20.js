...
练度流程列表['菲比20'] =
{
    ...
    buff_列表: {
        ...
        "声骸-检查-副词条": { "属性": { "暴击": 39.9, "爆伤": 62.4, "小攻击": 40 }, "标签": "检查" },
        "声骸-检查-副词条-重击": { "属性": { "增伤": 9.4 }, "标签": "重击,检查" },
        "声骸-检查-副词条-共鸣技能": { "属性": { "增伤": 23.6 }, "标签": "共鸣技能,检查" },
        "声骸-检查-副词条-共鸣解放": { "属性": { "增伤": 8.6 }, "标签": "共鸣解放,检查" },

        '光主减抗': { 属性: { 抗性: -10 } },
        '深塔-10抗': { 属性: { 抗性: -10 }, 标签: '检查', 描述: '角色受到治疗时，全队攻击提升30%，持续20秒' },
